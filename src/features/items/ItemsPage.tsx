				...
				<div className="items-right-panel">
					<div className="items-detail-header">
						<div className="items-header-content no-scrollbar">
							<div>
								<h1>{selectedItem ? selectedItem.item_name : 'Detail'}</h1>
							</div>
							{selectedItem && (
								<div>
									<div className="btn-group">
										<button type="button" className="btn-neutral" onClick={handleEditItem}>
					...
					<div className="items-detail-content">
						<ItemDetailView item={selectedItem} isLoading={loading && !selectedItem} />
					</div>
				</div>
			</div>
